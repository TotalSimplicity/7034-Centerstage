...
@Autonomous(preselectTeleOp = "mainTeleop", name = "Red Close side")
public class redAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(elementPos, "left")){
            ...
            drive.setPoseEstimate(curPos);
            drive.followTrajectorySequence(forwardBit);
            drive.setPoseEstimate(curPos);
            drive.followTrajectorySequence(backBit);
            rightOuttake();
            leftSlide.setTargetPosition(0);
            rightSlide.setTargetPosition(0);
            raiseFlip();
            ...
            raiseFlip();
            drive.setPoseEstimate(curPos);
            drive.followTrajectorySequence(middleBoard);
            rightIntakeTog();
            flip();
            flipTime.reset();
            while(flipTime.seconds() < 2.5){
            ...
            drive.setPoseEstimate(curPos);
            drive.followTrajectorySequence(parkLeft);
        } else if (Objects.equals(elementPos, "right")) {
            ElapsedTime flipTime = new ElapsedTime();
            raiseFlip();
